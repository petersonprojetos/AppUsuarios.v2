...
app.post('/user',(req,res)=>{
    ...
    let dstipousuario = req.body.dstipousuario;
    let dsobservacao = req.body.dsobservacao;
    ...
    let qr = `insert into tipo_usuario(ds_tipo_usuario, ds_observacao, cd_usuario_criador, cd_usuario_alteracao, dt_criacao, dt_alteracao, fg_ativo)
     values('${dstipousuario}','${dsobservacao}','1','1','${hoje}','${hoje}','${bloqueado}')` ;
